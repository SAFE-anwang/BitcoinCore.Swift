...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/safe-anwang/Checkpoints.git", .upToNextMajor(from: "1.0.14")),
        .package(url: "https://github.com/horizontalsystems/HdWalletKit.Swift.git", .upToNextMinor(from: "1.3.0")),
